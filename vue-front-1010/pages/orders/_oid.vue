    ...
    <form name="flowForm" id="flowForm" method="post" action="">
      <table class="GoodList">
        ...
        <tbody>
          ...
          <tr class="good">
            <td class="name First">
              <!-- <a target="_blank" :href="baseURL+'/course/'+order.courseId"> -->
              <a target="_blank" :href="'/course/'+order.courseId">
                <img :src="order.courseCover"></a>
              <div class="goodInfo">
                <input type="hidden" class="ids ids_14502" value="14502">
                <!-- <a target="_blank" :href="baseURL+'/course/'+ order.courseId">{{order.courseTitle}}</a> -->
...
export default {
  ...
  mounted () {
    ...
    var ells = document.querySelectorAll('#submitPay')
