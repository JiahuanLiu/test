      ...
      <section class="c-sort-box unBr">
        ...
        <div>
          <div class="paging">
            ...
            <a v-for="page in data.pages" id="button" :key="page" :class="{current: data.current == page, undisable: data.current == page}" :title="'第'+page+'页'" href="#" @click.prevent="gotoPage(page)">{{ page }}</a>

            <a id="button" :class="{undisable: !data.hasNext}" href="#" title="后一页" @click.prevent="gotoPage(data.current+1)">&gt;</a>
