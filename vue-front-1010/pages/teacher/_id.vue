              ...
              <li v-for="course in courseList" :key="course.id">
                <div class="cc-l-wrap">
                  <section class="course-img">
                    ...
                    <div class="cc-mask">
                      <a id="button" :href="'/course/'+course.id" title="开始学习" target="_self" class="comm-btn c-btn-1">开始学习</a>
                    </div>
                  </section>
                  <h3 class="hLh30 txtOf mt10">
                    <a id="button" href="#" :title="course.title" target="_self" class="course-title fsize18 c-333">{{course.title}}</a>
                  </h3>
                </div>
              </li>
